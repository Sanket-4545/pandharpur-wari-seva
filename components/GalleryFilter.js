      ...
      {categories.map((category) => {
        ...
        return (
          <button
            ...
            className={`px-4 sm:px-5 py-3 sm:py-3.5 rounded-xl font-heading text-xs sm:text-sm font-bold transition-all duration-300 transform active:scale-95 min-h-[44px] ${
              isActive 
