...
export default function StatusBadge({ status }) {
  ...
  const statusStyles = {
    ...
    // Volunteer Lost Items (new workflow)
    waiting: "bg-amber-50 text-amber-650 border-amber-200/60 dark:bg-amber-950/20 dark:text-amber-400 dark:border-amber-900/30",
    verified: "bg-blue-50 text-blue-650 border-blue-200/60 dark:bg-blue-950/20 dark:text-blue-400 dark:border-blue-900/30",
    returned: "bg-emerald-50 text-emerald-650 border-emerald-250/60 dark:bg-emerald-950/20 dark:text-emerald-400 dark:border-emerald-900/30",
    // Volunteers
    approved: "bg-emerald-50 text-emerald-650 border-emerald-200/60 dark:bg-emerald-950/20 dark:text-emerald-400 dark:border-emerald-900/20",
  ...
  const statusKeyMap = {
    ...
    waiting:  "volunteer_lost_items.status_waiting",
    verified: "admin.lost_items.status_verified",
    returned: "volunteer_lost_items.status_returned",
